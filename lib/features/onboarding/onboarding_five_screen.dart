...
class OnboardingFiveScreen extends ConsumerWidget {
  const OnboardingFiveScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final styles = ref.watch(learningStylesListProvider);
    final selectedIndices = ref.watch(onboardingLearningStylesProvider);
          ...
          children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CheckboxItemWidget(
                    ...
                    onTap: () {
                      ref
                          .read(onboardingLearningStylesProvider.notifier)
            ...
            Padding(
              ...
              child: CustomButton(
                text: 'Continue',
                onTap: () {
                  context.pushNamed(RoutePath.onboardingSixScreen);
                },
              ),
            ),
          ],
